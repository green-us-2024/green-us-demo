...
class MyGreenEndAdapter() :
    RecyclerView.Adapter<MyGreenEndAdapter.MyGreenEndViewHolder>() {
    ...
    inner class MyGreenEndViewHolder(view: View): RecyclerView.ViewHolder(view){
...
//        }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): MyGreenEndAdapter.MyGreenEndViewHolder {
        val cardView = LayoutInflater.from(parent.context)
            .inflate(R.layout.cardview_greening, parent, false)

        return MyGreenEndViewHolder(cardView)
    }

    override fun onBindViewHolder(holder: MyGreenEndViewHolder, position: Int) {
