...
//            em.persist(admin1)
//
//            val user1: User = createUser("유저1","password1", "aaa@naver.com", "2", "01011113333", admin1)
//            em.persist(user1)
//
//        }
//
...
//
//
//            val user2: User = createUser("유저2", "password2", "bbb@naver.com", "1", "01055553333", admin2)
//            em.persist(user2)
//
//        }
//
//        private fun createUser( name: String, pwd: String, email: String, addr: String, phone: String, admin:Admin): User {
//            val user = User(
//                    userName = name,
//                    userPwd = pwd,
//                    userEmail = email,
