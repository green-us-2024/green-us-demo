...
public final class ActivityNoticeBinding implements ViewBinding {
  ...
  private ActivityNoticeBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnEsc,
      @NonNull ConstraintLayout constraintLayout, @NonNull Guideline guideline1,
      @NonNull Guideline guideline2, @NonNull RecyclerView recyclerviewNotice) {
  ...
  public static ActivityNoticeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.recyclerview_notice;
      RecyclerView recyclerviewNotice = ViewBindings.findChildViewById(rootView, id);
      if (recyclerviewNotice == null) {
        break missingId;
      }

      return new ActivityNoticeBinding((ConstraintLayout) rootView, btnEsc, constraintLayout,
          guideline1, guideline2, recyclerviewNotice);
    }
