...
public final class ActivityJoinBinding implements ViewBinding {
  ...
  private ActivityJoinBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout joinContainer) {
  ...
  public static ActivityJoinBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.join_container;
      FrameLayout joinContainer = ViewBindings.findChildViewById(rootView, id);
      if (joinContainer == null) {
        break missingId;
      }

      return new ActivityJoinBinding((ConstraintLayout) rootView, joinContainer);
    }
