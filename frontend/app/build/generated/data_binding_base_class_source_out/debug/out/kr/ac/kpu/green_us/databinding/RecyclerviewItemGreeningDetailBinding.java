...
public final class RecyclerviewItemGreeningDetailBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static RecyclerviewItemGreeningDetailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecyclerviewItemGreeningDetailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recyclerview_item_greening_detail, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecyclerviewItemGreeningDetailBinding bind(@NonNull View rootView) {
