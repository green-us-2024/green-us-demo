...
class MyGreenIngMoreAdapter() :
    RecyclerView.Adapter<MyGreenIngMoreAdapter.MyGreenIngMoreViewHolder>() {
    ...
    inner class MyGreenIngMoreViewHolder(view: View): RecyclerView.ViewHolder(view){
...
//        }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): MyGreenIngMoreAdapter.MyGreenIngMoreViewHolder {
        // create a new view
        val cardView = LayoutInflater.from(parent.context)
            .inflate(R.layout.cardview_greening, parent, false)

        return MyGreenIngMoreViewHolder(cardView)
    }

    override fun onBindViewHolder(holder: MyGreenIngMoreViewHolder, position: Int) {
