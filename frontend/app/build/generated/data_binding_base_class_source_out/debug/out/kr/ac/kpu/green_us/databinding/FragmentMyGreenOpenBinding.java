...
public final class FragmentMyGreenOpenBinding implements ViewBinding {
  ...
  private FragmentMyGreenOpenBinding(@NonNull RecyclerView rootView,
      @NonNull RecyclerView recyclerviewOpenGreening) {
  ...
  public static FragmentMyGreenOpenBinding bind(@NonNull View rootView) {
    ...
    RecyclerView recyclerviewOpenGreening = (RecyclerView) rootView;

    return new FragmentMyGreenOpenBinding((RecyclerView) rootView, recyclerviewOpenGreening);
  }
}
